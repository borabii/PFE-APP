...
function DetailAbonnePopUp() {
  ...
  <div className="detailAbonne">
   ...
   <div className="detailAbonne__infoActiv">
         <h4> Historique</h4>
       <div className="infoActiv__container">

        <div className=" infoActiv__item">
         ...
         <div className="nbre_act">
              <h6> nombre d'activite</h6>
               <h6>354</h6>
                 </div>
                 </div>
