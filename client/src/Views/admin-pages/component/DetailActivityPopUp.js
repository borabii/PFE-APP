...
//           <div className="consulterActivite__top">
//             <img
...
//                 <dt>Description</dt>
//                 <dd>
//                   Bonjour je cherche une personne pur jouer un match fifa chez
//                   moi.
//                 </dd>
//                 <dt>Adresse</dt>
//                 <dd>
...
//                 </dd>
//                 <dt>Date debut</dt>
//                 <dd id="time">DIM.14 AVRIL 14:00</dd>
//                 <dt>Date fin</dt>
//                 <dd id="time">DIM.14 AVRIL 16:00</dd>
//               </dl>
//             </div>
//           </div>
...
import LocationOnIcon from "@material-ui/icons/LocationOn";
function DetailActivityPopUp(props) {
  const { categorie, description, adresse, date_debut, date_fin } = props.user;
  return (
    <Modal
      {...props}
      size="lg"
